...
pub use message::{
    ...
    InputMediaPhoto, InputMediaVideo, InputPollOption, Invoice, Location, MaybeInaccessibleMessage,
    Message, MessageAutoDeleteTimerChanged, MessageEntity, MessageEntityKind, MessageIdObject,
    MessageKind, MessageOrigin, OrderInfo, PaidMedia, PaidMediaInfo, PaidMessagePriceChanged,
    PhotoSize, Poll, PollKind, PollOption, ProximityAlertTriggered, RefundedPayment,
    ...
    SendVideoRequest, SendVoiceRequest, SentWebAppMessage, SharedUser, ShippingAddress, StarAmount,
