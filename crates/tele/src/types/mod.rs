...
pub use telegram::{
    ...
    InputProfilePhoto, InputStoryContent, InputStoryContentPhoto, InputStoryContentVideo,
    InputTextMessageContent, JsonCallbackCodec, KeyboardButton, LinkPreviewOptions,
    LocationAddress, MenuButton, MenuButtonCommands, MenuButtonDefault, MenuButtonKind,
    MenuButtonWebApp, PassportElementError, PreparedInlineMessage, PreparedKeyboardButton,
    ReactionType, ReactionTypeCustomEmoji, ReactionTypeEmoji, ReactionTypePaid,
