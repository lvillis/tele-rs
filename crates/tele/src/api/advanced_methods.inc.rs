...
macro_rules! with_advanced_methods {
    ($macro:ident) => {
        $macro! {
            ...
            (send_live_photo, send_live_photo_typed, "sendLivePhoto", AdvancedSendLivePhotoRequest),
            ...
            (answer_chat_join_request_query, answer_chat_join_request_query_typed, "answerChatJoinRequestQuery", AdvancedAnswerChatJoinRequestQueryRequest),
            (send_chat_join_request_web_app, send_chat_join_request_web_app_typed, "sendChatJoinRequestWebApp", AdvancedSendChatJoinRequestWebAppRequest),
            (get_user_personal_chat_messages, get_user_personal_chat_messages_typed, "getUserPersonalChatMessages", AdvancedGetUserPersonalChatMessagesRequest),
            ...
            (answer_guest_query, answer_guest_query_typed, "answerGuestQuery", AdvancedAnswerGuestQueryRequest),
            ...
            (get_managed_bot_access_settings, get_managed_bot_access_settings_typed, "getManagedBotAccessSettings", AdvancedGetManagedBotAccessSettingsRequest),
            (set_managed_bot_access_settings, set_managed_bot_access_settings_typed, "setManagedBotAccessSettings", AdvancedSetManagedBotAccessSettingsRequest),
            ...
            (edit_ephemeral_message_text, edit_ephemeral_message_text_typed, "editEphemeralMessageText", AdvancedEditEphemeralMessageTextRequest),
            (edit_ephemeral_message_media, edit_ephemeral_message_media_typed, "editEphemeralMessageMedia", AdvancedEditEphemeralMessageMediaRequest),
            (edit_ephemeral_message_caption, edit_ephemeral_message_caption_typed, "editEphemeralMessageCaption", AdvancedEditEphemeralMessageCaptionRequest),
            (edit_ephemeral_message_reply_markup, edit_ephemeral_message_reply_markup_typed, "editEphemeralMessageReplyMarkup", AdvancedEditEphemeralMessageReplyMarkupRequest),
            ...
            (delete_ephemeral_message, delete_ephemeral_message_typed, "deleteEphemeralMessage", AdvancedDeleteEphemeralMessageRequest),
            (delete_message_reaction, delete_message_reaction_typed, "deleteMessageReaction", AdvancedDeleteMessageReactionRequest),
            (delete_all_message_reactions, delete_all_message_reactions_typed, "deleteAllMessageReactions", AdvancedDeleteAllMessageReactionsRequest),
            ...
            (send_rich_message, send_rich_message_typed, "sendRichMessage", AdvancedSendRichMessageRequest),
            (send_rich_message_draft, send_rich_message_draft_typed, "sendRichMessageDraft", AdvancedSendRichMessageDraftRequest),
